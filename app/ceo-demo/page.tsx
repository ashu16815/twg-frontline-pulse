  ...
  return (
    <main className='max-w-7xl mx-auto px-6 py-10 space-y-8'>
      <div className='bg-green-50 border border-green-200 rounded-lg p-4 mb-6'>
        <h2 className='text-lg font-semibold text-green-800 mb-2'>🎯 Demo Mode with Real Azure AI</h2>
        <p className='text-green-700 text-sm'>
          This is a demonstration of the CEO dashboard with demo data but powered by real Azure OpenAI AI analysis. 
          The AI provides intelligent insights based on the demo data structure.
        </p>
      </div>
      ...
      <section className='card rounded-3xl'>
        <h2 className='text-lg font-semibold mb-3'>Ask the Data (Powered by Azure AI)</h2>
        <p className='opacity-70 mb-4'>Ask questions about this week's themes, risks, regions, or stores. Powered by real Azure OpenAI analysis.</p>
        <CEOChat />
      </section>
    </main>
  );
